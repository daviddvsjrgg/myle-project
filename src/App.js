  ...
  return (
      <div className="">
        ...
        <div className="relative">
          ...
          <div role="status">
                <svg aria-hidden="true" className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-purple-950" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/user-profile-admin" element={<ProtectedRoute element={<UserProfile />} path="/user-profile" allowedRoles={['admin']} />} />
