    ...
    <div className="min-h-full">
      ...
      <main>
        <div className="mx-auto max-w-7xl">
            ...
            {/* PIC Matkul */}
            <div className="bg-gray-100 border-2 border-gray-200 shadow-xl p-4 rounded-lg">
            {checkPenanggungJawab && (
            <>
                <div className="inline-flex bg-indigo-100 w-full rounded-md py-2">
                    <div className="bg-indigo-100 text-indigo-800  items-center ml-2 px-2.5 py-0.5 rounded-md">
                    ...
                    <div className="text-md md:text-xl font-medium ml-2 text-gray-700">Penanggung Jawab Matkul</div>
                </div>
            ...
            {/* Matkul Ku */}
            <div className="inline-flex bg-red-100 w-full rounded-md py-2">
                <div className="bg-red-100 text-red-800  items-center px-2.5 py-0.5 ml-2 rounded-md">
